...
namespace HADES.Data.Migrations
{
    ...
    [Migration("20210413174255_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("testUML.Models.AdminGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("testUML.Models.AppConfig", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("testUML.Models.DefaultUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("testUML.Models.Email", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("testUML.Models.OwnerGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("testUML.Models.OwnerGroupUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("testUML.Models.Role", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("testUML.Models.SuperAdminGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("testUML.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("testUML.Models.UserConfig", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("testUML.Models.AdminGroup", b =>
                {
                    b.HasOne("testUML.Models.AppConfig", "AppConfig")
            ...
            modelBuilder.Entity("testUML.Models.DefaultUser", b =>
                {
                    b.HasOne("testUML.Models.Role", "Role")
                        .WithMany("DefaultUsers")
                        .HasForeignKey("DUS_ROL_id");

                    b.HasOne("testUML.Models.UserConfig", "UserConfig")
                        .WithOne("DefaultUser")
                        .HasForeignKey("testUML.Models.DefaultUser", "DUS_UCF_id");
            ...
            modelBuilder.Entity("testUML.Models.OwnerGroupUser", b =>
                {
                    b.HasOne("testUML.Models.OwnerGroup", "OwnerGroup")
                        .WithMany("OwnerGroupUsers")
                        .HasForeignKey("GRU_GRP_id");

                    b.HasOne("testUML.Models.User", "User")
                        .WithMany("OwnerGroupUsers")
            ...
            modelBuilder.Entity("testUML.Models.User", b =>
                {
                    ...
                    b.HasOne("testUML.Models.UserConfig", "UserConfig")
                        .WithOne("User")
                        .HasForeignKey("testUML.Models.User", "USE_UCF_id");
